    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data, function (index, val) {
                ...
                var row = $('<tr><td>' + val.StdntId + '</td><td>' + val.StdntName + '</td><td>' + val.Course + '</td><td>' + marked + '</td><td>' + marked + '</td><td>' + marked + '</td><td>' + marked + '</td><td>' + marked + '</td></tr>');
